    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10">
          ...
          <a
            href="#contact"
            className="bg-yellow-400 text-black px-4 py-2 text-sm tracking-wider rounded-sm 
        ...
        <div className="bg-black/95 backdrop-blur-md border-t border-gray-800">
          <ul className="flex flex-col items-center gap-6 py-8 text-gray-200 tracking-[0.2em] text-lg">
            ...
            <a
              href="#contact"
              onClick={() => setMobileOpen(false)}
              className="mt-4 bg-yellow-400 text-black px-6 py-2 text-sm tracking-wider rounded-sm 
              hover:bg-yellow-300 transition duration-300 transform hover:scale-105"
            >
              GET A QUOTE
            </a>
