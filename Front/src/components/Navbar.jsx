  ...
  return (
    ...
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-700 ease-in-out
        ...
        ${scrolled ? "bg-black/90 backdrop-blur-md shadow-lg" : "bg-black/30 backdrop-blur-sm"}
      `}
    >
      {/* MAIN NAV */}
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <h1 className="font-brainy text-xl md:text-2xl tracking-[0.12em] text-yellow-400 
      ...
      {/* MOBILE MENU */}
      <div className={`md:hidden overflow-hidden transition-[max-height,opacity] duration-500 ease-in-out ${mobileOpen ? "max-h-[400px] opacity-100" : "max-h-0 opacity-0"}`}>
