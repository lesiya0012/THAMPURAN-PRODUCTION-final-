...
export default function Preloader() {
  return (
    <div className="fixed inset-0 bg-black flex items-center justify-center z-[9999]">
      <div className="flex flex-col items-center gap-6 px-4 opacity-0 animate-[fadeIn_1.2s_ease-in-out_forwards]">
        ...
        {/* Title */}
        <div className="relative mt-4 opacity-0 animate-[fadeText_2s_cubic-bezier(0.22,1,0.36,1)_0.8s_forwards] text-center">
          
          {/* Glow layer */}
          <h1 className="absolute inset-0 font-brainy text-3xl sm:text-4xl md:text-6xl 
